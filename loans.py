...
class Loans():
    ...
    def genLoanCalc(self,loan,years,compType='daily'):
    ...
    def mortgageCalc(self,house,years,curBal=None,curPay=None,curInt=None,curWth=None,curTax=None,curDwn=None,sellPrev=True,app=0.0375):        
