...
var = {
    ...
    'loans':{
        'collegeLoan':np.array([0,4,(3.86*(3500/27500)) + (4.66*(1700/27500)) + (4.29*(2750/27500)) + \
                                    (3.86*(2000/27500)) + (4.66*(1300/27500)) + (4.29*(1000/27500)) + \
                                    (3.76*(7500/27500)) + (4.45*(7500/27500)),7500]),
    ...
    'baseSavings':np.asarray([[700],                    #hiDiv      (VYM)
                              ...
                              [6500 + 15000 + 0],   #longTerm   (Goldman Sach's, BoA, Vanguard)
