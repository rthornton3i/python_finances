...
var = {
    ...
    'loans':{
        'collegeLoan':np.array([0,5,(3.86*(3500/27500)) + (4.66*(1700/27500)) + (4.29*(2750/27500)) + \
                                    (3.86*(2000/27500)) + (4.66*(1300/27500)) + (4.29*(1000/27500)) + \
                                    (3.76*(7500/27500)) + (4.45*(7500/27500)),20000]),
    ...
    'baseSavings':np.asarray([[700],                    #hiDiv      (VYM)
                              ...
                              [6500 + 15000 + 10000],   #longTerm   (Goldman Sach's, BoA, Vanguard)
    ...
    'allocations':np.asarray([[2.5  , 2.5  , 2.5  , 7.5  , 5    ],     #hiDiv
                              ...
                              [40   , 52.5 , 7.5  , 32.5 , 30   ],     #longTerm
                              [22.5 , 10   , 22.5 , 25   , 25   ],     #shortTerm
